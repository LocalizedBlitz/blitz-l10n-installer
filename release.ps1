...
Write-Host "    https://github.com/LocalizedBlitz/blitz-l10n-installer/releases/tag/$tagName"
Write-Host ""
...
Write-Host ""
Write-Host "Check progress at: https://github.com/LocalizedBlitz/blitz-l10n-installer/actions" -ForegroundColor Cyan
